...
if (!$staticData){
	...
	<h1>First Run</h1>
	<div id="firstContent">
		<p>This looks like the first time you've opened this extension, please click the button below & then open the extension again</p>
		<button id="install">Install data</button>
	</div>
	<?php
} else {
?>
